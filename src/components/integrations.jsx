...
const Integrations = () => {
  return (
    <section className="py-24 bg-[#0a0a0a] grid-background" id="integrations">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          >
            <span className="text-[#00A3FF]">INTEGRATIONS</span>
          </motion.div>
        ...
        <div className="py-8 relative overflow-hidden">
          <div className="h-[10rem] w-full bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="bg-gradient-to-br from-[#0f1722] to-[#0a0a0a] border border-gray-800 rounded-xl p-6"
          >
            <div className="h-12 w-12 bg-[#00A3FF]/10 rounded-lg flex items-center justify-center mb-4">
